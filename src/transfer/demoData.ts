...
export const demoData: ExportFile = {
  ...
  portfolioIds: [
    ...
    'demo-0001-0001-0001-000000000010',
    'demo-0001-0001-0001-000000000011',
    'demo-0001-0001-0001-000000000012',
  ],
  results: [
    {
    ...
    {
      id: 'demo-0001-0001-0001-000000000010',
      timestamp: 1741306500000,
      startAmount: 9000,
      annualInterestRate: 2.45,
      durationMonths: 36,
    ...
    {
      id: 'demo-0001-0001-0001-000000000011',
      timestamp: 1741306600000,
      startAmount: 10000,
    ...
    {
      id: 'demo-0001-0001-0001-000000000012',
      timestamp: 1741306700000,
      startAmount: 10000,
